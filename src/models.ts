...
export const environmentalMetricValues: MetricValues<EnvironmentalMetric, EnvironmentalMetricValue> = {
...
export const temporalMetricValues: MetricValues<TemporalMetric, TemporalMetricValue> = {
...
export type AllMetricValues = typeof temporalMetricValues | typeof environmentalMetricValues | typeof baseMetricValues;

export type Metrics<M = Metric> = ReadonlyArray<M>;

export const baseMetrics: Metrics<BaseMetric> = [
